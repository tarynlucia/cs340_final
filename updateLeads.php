...
if(isset($_GET["Event_number"]) && !empty(trim($_GET["Event_number"]))){
    ...
    $sql1 = "SELECT * FROM Leads WHERE Event_number = ?";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($OSU_ID_err)){
        ...
        $sql = "INSERT INTO Leads (Event_number, OSU_ID)
                VALUES ($Event_number, ?)";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                header("location: viewLeads.php?Event_number=$Event_number");
                exit();
            } else{
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="updateLeads.php?Event_number=<?php echo $Event_number; ?>" method="post">
                        ...
                        <a href="viewLeads.php?Event_number=<?php echo $Event_number ?>" class="btn btn-default">Cancel</a>
                    </form>
                </div>
            </div>        
        </div>
